...
namespace IngameScript
{
    partial class Program : MyGridProgram
    {
        ...
        public void Main(string argument, UpdateType updateSource)
        {
            ...
            {
                fs.Add(g.CustomName + ": " + (grids[g] * 1000).ToString("0") + (grids[g]) + " kWh");
            }

            WriteToLcds(fs, "[BatStat]", _l, _c, _s);
            ...
            fs.Add("Input: " + GetKW(total));
            fs.Add("Output: " + GetKW(output));
            fs.Add("Sum: " + GetKW(total - output));


            WriteToLcds(fs, "[BatStat1]", _l, _c, _s);
        }
